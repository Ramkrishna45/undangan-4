...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'शुभ विवाह - बालकृष्ण संग ज्योति',
            dates: `${formatDate('2026-05-07 19:30')}/${formatDate('2026-05-07 19:30')}`,
            location: 'HFP5+9X Malaon Mus, Uttar Pradesh',
            ctz: 'Asia/Kolkata',
        });
    ...
    // 🔴 OFFLINE MODE HARD EXIT
    if (window.__UNDANGAN_OFFLINE__ === true) {
        console.warn('Offline mode enabled – skipping API, session & cache');
